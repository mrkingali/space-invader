...
public class Enemy2 extends Enemy{
    Image url1 = new Image("assets/alien_two_white.png", Constants.AlienLength, Constants.AlienWidth, true, false);
    Image url2=new Image("assets/alien_two_white_2.png",Constants.AlienLength,Constants.AlienWidth,false,true);
    ImageView image2 = new ImageView(url2);
    ImageView image1 = new ImageView(url1);

    public Enemy2(int layoutX, int layoutY) {
        imageState=true;
